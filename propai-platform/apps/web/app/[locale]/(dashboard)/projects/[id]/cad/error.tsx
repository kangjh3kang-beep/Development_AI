...
export default function CadError({
  ...
  useEffect(() => {
    ...
    reportBoundaryError("dashboard-projects-id-cad-error", error);
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] gap-6 p-8">
      ...
      <h2 className="text-2xl font-black text-[var(--text-primary)]">CAD 도면을 불러오는 중 문제가 발생했습니다</h2>
