      ...
      <CardContent className="grid gap-4 pt-0">
            ...
            <button
              ...
              className={`rounded-full border px-4 py-2 text-sm font-medium transition ${
                selectedCategory === category
                  ? "border-[var(--foreground)] bg-[var(--foreground)] text-[#ffffff]"
                  : "border-[var(--line)] bg-[var(--surface-soft)] text-[rgba(19,33,47,0.76)]"
              }`}
            >
              {category}
            </button>
        ...
        <div className="overflow-hidden rounded-[1.5rem] border border-[var(--line)]">
          <table className="min-w-full divide-y divide-[var(--line)] bg-[var(--surface-soft)] text-left text-sm">
            <thead className="bg-[var(--surface-muted)] text-[rgba(19,33,47,0.72)]">
              <tr>
            ...
            <tbody className="divide-y divide-[var(--line)]">
              {filtered.map((item) => (
                <tr key={item.id}>
                  <td className="px-4 py-4 text-[rgba(19,33,47,0.68)]">
                    {item.category}
                  </td>
                  ...
                  <td className="px-4 py-4 text-[rgba(19,33,47,0.76)]">
