 ...
 *  • 기본: 배경 영상(hero-newtown.mp4) autoPlay muted loop playsInline + 마운트 후 play().catch 킥.
...
export function HeroMotionLayer() {
  ...
  return (
    <video
      ...
      playsInline
      preload="metadata"
      poster="/home/hero-newtown-poster.webp"
      onError={() => setMode("canvas")}
    >
      <source src="/home/hero-newtown.mp4" type="video/mp4" />
    </video>
  );
}
