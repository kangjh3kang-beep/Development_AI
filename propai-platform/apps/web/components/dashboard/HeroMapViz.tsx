...
export function HeroMapViz() {
  return (
    <div className="db-hero__viz" aria-hidden="true">
      ...
      <div 
        className="absolute -inset-y-4 right-0 w-[100%] md:w-[75%] lg:w-[65%] bg-[url('/images/korea-map.png')] bg-no-repeat bg-right bg-contain opacity-60 mix-blend-screen scale-110 translate-x-4"
        style={{
