 ...
 *  · 지도 레이어는 **기본 꺼짐**이다
 *    (★2026-09-07 좌표 정정 — 인용했던 `SatongMapShell` 의 `new Set(["cadastre"])` 는
 *     이미 `store/useSatongMapPrefsStore.ts` 의 `defaultEnabledLayerIds()` 로 옮겨졌고,
 *     그 값도 사용자 신고①로 `[]` 가 됐다. 「공·경매가 기본 꺼짐」이라는 **결론은 그대로**다.)
