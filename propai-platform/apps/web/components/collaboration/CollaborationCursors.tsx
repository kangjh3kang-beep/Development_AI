  ...
  return (
    <Card className="bg-[var(--surface-strong)]">
      ...
      <CardContent className="pt-0">
        <div className="relative min-h-[220px] overflow-hidden rounded-[1.5rem] border border-[var(--line)] bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(248,243,233,0.94))]">
          ...
          {members.map((member) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                />
                <div className="rounded-full bg-white/90 px-3 py-2 shadow-[0_8px_24px_rgba(19,33,47,0.08)]">
                  <p className="text-xs font-semibold text-[var(--foreground)]">
                    {member.name}
                  </p>
                  <p className="text-[11px] text-[rgba(19,33,47,0.56)]">
                    {member.role}
                  </p>
                </div>
              </div>
