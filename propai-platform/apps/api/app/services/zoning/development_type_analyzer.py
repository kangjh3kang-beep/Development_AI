...
ZONE_ALLOWED_BUILDINGS: dict[str, list[dict[str, Any]]] = {
    "제1종전용주거지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표2"},
        {"type_name": "공동주택(다세대)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "4층 이하", "legal_basis": "시행령 별표2"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "바닥면적 합계 1,000㎡ 미만", "legal_basis": "시행령 별표2"},
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표2"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "초등학교", "legal_basis": "시행령 별표2"},
    ],
    "제2종전용주거지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표3"},
        {"type_name": "공동주택(아파트 제외)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표3"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표3"},
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
        ...
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표3"},
        {"type_name": "노유자시설", "type_code": "11", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표3"},
    ],
    "제1종일반주거지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표4"},
        {"type_name": "공동주택(아파트 제외)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "4층 이하", "legal_basis": "시행령 별표4"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표4"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
         "conditions": "일부 업종 제한", "legal_basis": "시행령 별표4"},
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표4"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표4"},
    ...
    "제2종일반주거지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "공동주택(아파트 포함)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
        ...
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "의료시설", "type_code": "09", "min_area_sqm": 0,
         "conditions": "병원", "legal_basis": "시행령 별표5"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "노유자시설", "type_code": "11", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "운동시설", "type_code": "13", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표5"},
        {"type_name": "업무시설(오피스텔)", "type_code": "14", "min_area_sqm": 300,
         "conditions": "준주거지역 인접 시", "legal_basis": "시행령 별표5"},
    ],
    "제3종일반주거지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표6"},
        {"type_name": "공동주택(아파트 포함)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표6"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표6"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표6"},
        {"type_name": "문화 및 집회시설", "type_code": "05", "min_area_sqm": 0,
         "conditions": "공연장, 전시장", "legal_basis": "시행령 별표6"},
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표6"},
        {"type_name": "의료시설", "type_code": "09", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표6"},
    ...
    "준주거지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "공동주택(아파트 포함)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "판매시설", "type_code": "07", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "의료시설", "type_code": "09", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "업무시설", "type_code": "14", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표7"},
        {"type_name": "숙박시설", "type_code": "15", "min_area_sqm": 500,
         "conditions": "조례 허용 시", "legal_basis": "시행령 별표7"},
        {"type_name": "주상복합", "type_code": "02+14", "min_area_sqm": 1000,
         "conditions": "주거비율 90% 이하", "legal_basis": "시행령 별표7"},
    ],
    "중심상업지역": [
        {"type_name": "업무시설", "type_code": "14", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
        {"type_name": "판매시설", "type_code": "07", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
        {"type_name": "공동주택(아파트 포함)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "주거비율 제한", "legal_basis": "시행령 별표8"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
        {"type_name": "문화 및 집회시설", "type_code": "05", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
        {"type_name": "숙박시설", "type_code": "15", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
        {"type_name": "의료시설", "type_code": "09", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표8"},
    ],
    "일반상업지역": [
        {"type_name": "업무시설", "type_code": "14", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표9"},
        {"type_name": "판매시설", "type_code": "07", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표9"},
        {"type_name": "공동주택(아파트 포함)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표9"},
        ...
        {"type_name": "숙박시설", "type_code": "15", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표9"},
        {"type_name": "주상복합", "type_code": "02+14", "min_area_sqm": 1000,
         "conditions": "주거비율 제한", "legal_basis": "시행령 별표9"},
    ],
    "근린상업지역": [
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표10"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표10"},
        {"type_name": "판매시설", "type_code": "07", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표10"},
        ...
        {"type_name": "의료시설", "type_code": "09", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표10"},
        {"type_name": "숙박시설", "type_code": "15", "min_area_sqm": 300,
         "conditions": "조례 허용 시", "legal_basis": "시행령 별표10"},
    ],
    "유통상업지역": [
        {"type_name": "판매시설", "type_code": "07", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표11"},
        {"type_name": "운수시설", "type_code": "08", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표11"},
        {"type_name": "업무시설", "type_code": "14", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표11"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
    ...
    "전용공업지역": [
        {"type_name": "업무시설", "type_code": "14", "min_area_sqm": 0,
         "conditions": "공장 부속 사무소", "legal_basis": "시행령 별표12"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "공장지원 시설", "legal_basis": "시행령 별표12"},
    ],
    "일반공업지역": [
        {"type_name": "업무시설", "type_code": "14", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표13"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표13"},
        {"type_name": "제2종 근린생활시설", "type_code": "04", "min_area_sqm": 0,
         "conditions": "일부 제한", "legal_basis": "시행령 별표13"},
        {"type_name": "의료시설", "type_code": "09", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표13"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "직업훈련소 등", "legal_basis": "시행령 별표13"},
    ],
    "준공업지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표14"},
        {"type_name": "공동주택(아파트 포함)", "type_code": "02", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표14"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표14"},
    ...
    "보전녹지지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "기존 건축물 증·개축", "legal_basis": "시행령 별표15"},
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표15"},
    ],
    "생산녹지지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표16"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표16"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표16"},
    ...
    "자연녹지지역": [
        {"type_name": "단독주택", "type_code": "01", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표17"},
        {"type_name": "제1종 근린생활시설", "type_code": "03", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표17"},
        {"type_name": "종교시설", "type_code": "06", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표17"},
        {"type_name": "교육연구시설", "type_code": "10", "min_area_sqm": 0,
         "conditions": "", "legal_basis": "시행령 별표17"},
        {"type_name": "수련시설", "type_code": "12", "min_area_sqm": 0,
         "conditions": "자연학습장 등", "legal_basis": "시행령 별표17"},
    ],
}
