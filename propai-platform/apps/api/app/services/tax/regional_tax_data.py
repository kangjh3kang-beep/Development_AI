...
ACQUISITION_TAX_MATRIX: dict[tuple[str, int, bool], tuple[float, float, float, float]] = {
    ...
    ("land", 2, True):  (0.080, 0.0, 0.004, 0.006),  # 조정지역 2주택 중과
    # 대지(land) — 주택 3주택+
    ("land", 3, False): (0.040, 0.0, 0.004, 0.002),
    ("land", 3, True):  (0.120, 0.0, 0.004, 0.010),  # 조정지역 3주택 중과
}
...
WATER_SUPPLY_CHARGES_WON: dict[str, int] = {
    ...
    "경기_화성시": 110_000, "경기_오산시": 120_0000,
