...
def build_template_xlsx() -> bytes:
    ...
    notes = [
        ...
        "",
        "★ 「토지조서」 시트에 **[소재지(주소)] 와 [지번] 두 칸만** 채워서 올리면 됩니다.",
        "   나머지(법정동코드·PNU·지목·면적·소유구분 등)는 **자동으로 조회**합니다.",
        "",
        "1) [소재지(주소)] 는 필수입니다. 시·도부터 동까지 적어 주세요.",
        "     예)  경기도 의정부시 의정부동 224",
        "          경기도 안양시 동안구 비산동 511-168",
        "          서울특별시 강남구 역삼동 737",
        "2) [지번] 은 주소 끝의 번지만 다시 적어 주세요.  예) 224 · 511-168 · 737",
        "     → 주소에 이미 들어 있어도 **따로 적어 주시면 더 정확합니다**"
        "(주소 표기가 흔들려도 지번으로 필지를 특정합니다).",
        "3) '산' 지번은 '산12-3' 처럼 '산' 을 붙여 적으세요.",
        f"4) 한 번에 최대 {_MAX_ROWS}필지까지 업로드됩니다.",
        "",
        "■ 예시 (이 시트의 예시를 보고 「토지조서」 시트에 직접 입력하세요)",
        "     소재지(주소)                         | 지번",
        "     경기도 의정부시 의정부동 224          | 224",
        "     경기도 안양시 동안구 비산동 511-168   | 511-168",
        "",
        "★ 「토지조서」 시트에는 **예시행을 넣어 두지 않았습니다.**",
        "   예시를 지우지 않고 올려서 **없는 필지가 등록되는 일**을 아예 없애기 위해서입니다.",
        "",
