...
# ★M08 오피스텔 편입(R1 교정): 분양형 오피스텔=준주택 포함이라 학교용지부담금 부과 대상
#   (학교용지법 §2 3호·2021.6.23~ — 요율 판정 SSOT는 utility_stage_engine.school_site_rate_for).
# M09 지산은 대상 아님. 단독계열(M10~M12)도 §5의2(1.4%) 대상이나 본 템플릿 라인 노트가
# 공동주택 0.4% 표기라 후속 편입 대기(산정 엔진은 이미 1.4% 분기 — 표시 전용 갭).
_APARTMENT_METHODS = {"M01", "M02", "M03", "M04", "M05", "M06", "M07", "M08", "M13", "M14", "M15"}
