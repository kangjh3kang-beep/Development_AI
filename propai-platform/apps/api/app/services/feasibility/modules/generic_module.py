...
class GenericModule(BaseModule):
    ...
    def calculate(self, inp: ModuleInput) -> ModuleOutput:
        ...
        # ── P0-2: 금융비·소프트비 자동추정 — 공용 함수(cost_blocks.apply_auto_estimates)로
        #    이관(2026-07-15 감사 수지10: 이 블록이 여기에만 있어 M01/M02/M04/M08은 미적용이던
        #    비대칭 봉합 — 5개 모듈이 동일 표준 가정 공유). 수치·표기 동일(무회귀).
